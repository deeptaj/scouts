...
session_start();
if(!isset($page_title)) { $page_title = 'Project Access'; }
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            ...
            if (isset($_SESSION['role'])){
                echo '<li class="nav-item active"><a class="nav-link" id="header" href="schools_list.php">Schools<span class="sr-only">(current)</span></a>';
