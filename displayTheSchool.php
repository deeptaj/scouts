...
<?php $page_title = 'Display  School'; ?>
<?php $page_title = 'Project Access > Display School'; ?>
<?php 
...
if ($result->num_rows > 0) {
      ...
      echo '<h2 id="title">Information about the School</h2><br>';
      ...
      <b> School Information "' . $row["name"] . '"? </b>
      ...
      <tr>
          ...
          <td><input readonly type="text" name="name" maxlength="100" size="100" required title="Please enter the name of the school." value= "'.$row["name"] .'"></td>
      </tr>
      ...
      <tr>
         ...
         <td> <input readonly type="number" id="year_input" name="year_founded" min="1920" max="2020" value="' .$row["year_founded"]. ' "></td>
      </tr>
      ...
      <tr>
          ...
          <td> <input readonly type="number" id="current_enrollment" name="current_enrollment" min="1" max="2000" value="' .$row["current_enrollment"]. '"></td>
      </tr>

      
      <tr>
        <td style="width:100px">Total Students Served:</td>
        <td> <input readonly type="number" id="total_students_served" name="total_students_served" min="1" max="5000" value="' .$row["total_students_served"]. '"></td>
      </tr>


      <tr>
        <td style="width:100px">Mobile Number:</td>
        <td><input readonly type="text" name="mobile" maxlength="50" size="50" value="' .$row["mobile"]. '" ></td>
      </tr>

      <tr>
        <td style="width:100px">Web Site:</td>
        <td> <input readonly type="url" name="website" id="website" size="50" value="' .$row["website"]. '"> </td>
      </tr>
      
      <tr>
        <td style="width:100px">Email:</td>
        <td><input readonly type="email" name="email" maxlength="50" size="50" value="' .$row["email"]. '"></td>
      </tr>

      
      <tr>
        <td style="width:100px">Address:</td>
        <td><textarea readonly name="address" maxlength="300" rows="7" cols="52"> ' .$row["address"]. ' </textarea> </td>
      </tr>

      <tr>
        <td style="width:100px">Pin (Zip) Code:</td>
        <td><input readonly type="text" name="zip_code" maxlength="50" size="50" value="' .$row["zip_code"]. '"></td>
      </tr>

      <tr>
        <td style="width:100px">Key Words:</td>
        <td><input readonly type="text" name="keywords" maxlength="100" size="50" value="' .$row["keywords"]. '"></td>
      </tr>
